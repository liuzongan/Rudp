...
/**
 * Created by IntelliJ IDEA 14. User: karl.zhao Time: 2016/1/21 0021.
 */
public class UdpServerHandler extends
		SimpleChannelInboundHandler<DatagramPacket>
{
	private static final String[] DICTIONARY = { "看我的，hello world", "C++",
			"C#", "Java", "python" };
		...
		// 因为Netty对UDP进行了封装，所以接收到的是DatagramPacket对象。
				...
				//if ("啪啪啪来拉！！！".equals(req))
				{
					ctx.writeAndFlush(new DatagramPacket(Unpooled
							.copiedBuffer("结果：" + nextQuoto(), CharsetUtil.UTF_8),
							msg.sender()));
				}
